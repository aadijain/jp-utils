...
class Settings(BaseSettings):
    ...
    # Base URL of the Yomitan local-audio-yomichan server (standalone WO_ANKI=1).
    # The backend proxies it for word audio; the add-on never calls it directly.
    # Typically co-hosted with the backend, so localhost by default.
