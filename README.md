...
The **backend** exposes a batch-first, bearer-authenticated HTTP API: tokenization, word spacing, furigana, kana/romaji conversion, dictionary meanings, frequency ranks, deinflection, and content-word extraction. See [backend/README.md](backend/README.md) for the full endpoint list.
